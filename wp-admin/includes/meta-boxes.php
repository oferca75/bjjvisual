        ...
        <div class="jaxtag">
            <div class="nojs-tags hide-if-js">
                ...
                <p><textarea name="<?php echo "tax_input[$tax_name]"; ?>" rows="3" cols="20" class="the-tags"
                             ...
                             aria-describedby="new-tag-<?php echo $tax_name; ?>-desc"><?php echo str_replace ( ',' , $comma . ' ' , $terms_to_edit ); // textarea_escaped by esc_attr() ?></textarea>
                </p>
            </div>
    ...
    <table class="links-table" cellpadding="0">
        <tr>
            ...
            <td><input type="text" name="link_image" class="code" id="link_image" maxlength="255"
                       value="<?php echo ( isset( $link->link_image ) ? esc_attr ( $link->link_image ) : '' ); ?>"/>
            </td>
        </tr>
        <tr>
