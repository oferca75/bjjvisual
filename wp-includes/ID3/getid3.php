...
{
	// public: Settings
	const VERSION = '1.9.9-20141121';        // CASE SENSITIVE! - i.e. (must be supported by iconv()). Examples:  ISO-8859-1  UTF-8  UTF-16  UTF-16BE
	const FREAD_BUFFER_SIZE = 32768;   // Should always be 'ISO-8859-1', but some tags may be written in other encodings such as 'EUC-CN' or 'CP1252'
	
	// public: Optional tag checks - disable for speed.
	const ATTACHMENTS_NONE = false;  // Read and process ID3v1 tags
	const ATTACHMENTS_INLINE = true;  // Read and process ID3v2 tags
	public $encoding = 'UTF-8';  // Read and process Lyrics3 tags
	public $encoding_id3v1 = 'ISO-8859-1';  // Read and process APE tags
	public $option_tag_id3v1 = true;  // Copy tags to root key 'tags' and encode to $this->encoding
	public $option_tag_id3v2 = true;  // Copy tags to root key 'tags_html' properly translated from various encodings to HTML entities
	
	// public: Optional tag/comment calucations
	public $option_tag_lyrics3 = true;  // Calculate additional info such as bitrate, channelmode etc
	
	// public: Optional handling of embedded attachments (e.g. images)
	public $option_tag_apetag = true; // defaults to true (ATTACHMENTS_INLINE) for backward compatibility
	
	// public: Optional calculations
	public $option_tags_process = true; // Get MD5 sum of data part - slow
	public $option_tags_html = true; // Use MD5 of source file if availble - only FLAC and OptimFROG
	public $option_extra_info = true; // Get SHA1 sum of data part - slow
	public $option_save_attachments = true;  // Check whether file is larger than 2GB and thus not supported by 32-bit PHP (null: auto-detect based on PHP_INT_MAX)
	
	// public: Read buffer size in bytes
	public $option_md5_data = false;
	
	// Public variables
	public $option_md5_data_source = false;                         // Filename of file being analysed.
	public $option_sha1_data = false;                               // Filepointer to file being analysed.
	public $option_max_2gb_check = null;                             // Result array.
