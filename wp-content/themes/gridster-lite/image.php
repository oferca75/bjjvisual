                ...
                <header class="entry-header">
                    ...
                    <nav role="navigation" id="image-navigation" class="navigation-image">
                        <div class="nav-previous">
                            <?php previous_image_link ( false , __ ( '<span class="meta-nav">&larr;</span> Previous' , 'gridster' ) ); ?>
                        </div>
                        <div class="nav-next">
                            <?php next_image_link ( false , __ ( 'Next <span class="meta-nav">&rarr;</span>' , 'gridster' ) ); ?>
                        </div>
                    </nav>
                    <!-- #image-navigation -->
                </header>
