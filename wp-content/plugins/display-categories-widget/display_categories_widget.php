...
class DisplayCategoriesWidget extends WP_Widget
{
    ...
    function form ( $instance )
    {
        ...
        <p>
            <label for="<?php echo $this->get_field_id ( 'dcw_option_name' ); ?>"><?php _e ( 'Label no-selection (optional):' ); ?>
        ...
        <p>
            <label for="<?php echo $this->get_field_id ( 'dcw_exclude' ); ?>"><?php _e ( 'Category ID\'s to exclude (optional):' ); ?>
        ...
        <p>
            <label for="<?php echo $this->get_field_id ( 'dcw_depth' ); ?>"><?php _e ( 'Levels in the hierarchy to show (optional):' ); ?>
