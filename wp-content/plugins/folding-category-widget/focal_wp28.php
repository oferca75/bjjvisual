            ...
            <div class="wrap">
                <form method="post" action="<?php echo $_SERVER[ 'REQUEST_URI' ]; ?>">
                    ...
                    <span style="float:right"><input type="submit" name="focalSubmitOptions"
                                                     value="<?php _e ( 'Save Changes' , 'focal' ); ?>" class="button"/></span>
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <label><input type='radio' name='focal_IncExCategories'
                                    ...
                                    <span class="setting-description"><?php _e ( 'The categories ticked below will be <strong>Excluded</strong> from FoCaL.' , 'focal' ); ?></span></label><br/>
                                <label><input type='radio' name='focal_IncExCategories'
                                              value='inc'<?php if ( $this->widgetOptions[ 'IncOrEx' ] == 'inc' ) echo ' checked'; ?>>
                                    <span class="setting-description"><?php _e ( 'Only the categories ticked below will be <strong>Included</strong> in FoCaL.' , 'focal' ); ?></span></label><br/><br/>
                                <?php
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <br/>
                                <label for="focal_widegtCountBefore"><?php _e ( 'Before post count:' , 'focal' ); ?> </label><input
                                ...
                                <label for="focal_widegtCountAfter"><?php _e ( 'After post count:' , 'focal' ); ?> </label><input
